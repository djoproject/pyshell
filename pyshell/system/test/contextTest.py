...
class ContextTest(unittest.TestCase):
    ...
    def test_localSettings3(self):#setIndex with correct value
        c = ContextParameter( (0,1,2,3,), typ=IntegerArgChecker(),default_index=2,index=1  )
    ...
    def test_localSettings6(self):#setIndex with valid value and readonly
        c = ContextParameter( (0,1,2,3,), typ=IntegerArgChecker(), settings=LocalContextSettings(read_only=True))
        self.assertRaises(ParameterException, )

    def test_localSettings7(self):#tryToSetIndex with correct value
        c = ContextParameter( (0,1,2,3,), typ=IntegerArgChecker(),default_index=2 )
    ...
    def test_localSettings11(self):#tryToSetIndex with valid value and readonly
        c = ContextParameter( (0,1,2,3,), typ=IntegerArgChecker(),default_index=2, settings=LocalContextSettings(read_only=True ))
        self.assertEqual(c.getSelectedValue(),0)
        c.settings.tryToSetIndex(3)
        self.assertEqual(c.getSelectedValue(),3)
        
    def test_localSettings12(self):#tryToSetIndex, create a test to set default_index
        c = ContextParameter( (0,1,2,3,), typ=IntegerArgChecker(), index = 3, default_index = 1)
        self.assertEqual(c.getSelectedValue(), 3)
    ...
    def test_localSettings16(self):#setIndexValue with valid value and readonly
        c = ContextParameter( ("aa","bb","cc","dd",), typ=stringArgChecker(), settings=LocalContextSettings(read_only=True ))
        self.assertEqual(c.getSelectedValue(),"aa")
        c.settings.setIndexValue("cc")
        self.assertEqual(c.getSelectedValue(),"cc")

    def test_localSettings17(self):#setDefaultIndex with correct value
        c = ContextParameter( ("aa","bb","cc","dd",), typ=stringArgChecker(), default_index=2)
    ...
    def test_localSettings20(self):#setDefaultIndex with valid value and readonly
        c = ContextParameter( ("aa","bb","cc","dd",), typ=stringArgChecker(), default_index=2, settings=LocalContextSettings(read_only=True))
    ...
    def test_localSettings25(self): #tryToSetDefaultIndex, create a test to set default_index to zero
        c = ContextParameter( (0,1,2,3,), typ=IntegerArgChecker(), default_index = 3)
    ...
    def test_localSettings26(self):#test reset
        c = ContextParameter( ("aa","bb","cc","dd",), typ=stringArgChecker(), default_index=2, index=1)
        self.assertEqual(c.settings.getDefaultIndex(), 2)
    ...
    def test_localSettings27(self):#test getProperties
        c = ContextParameter( (0,1,2,3,) ,index=2, default_index=3, settings=LocalContextSettings( removable=False, read_only=True))
    ...
    def test_globalSettings1(self): #__init__ test each properties, True
        c = ContextParameter( ("aa","bb","cc","dd",), typ=stringArgChecker(), settings=GlobalContextSettings(read_only = True, removable = True, transient = True, transient_index = True ))
    ...
    def test_globalSettings2(self): #__init__ test each properties, False
        c = ContextParameter( ("aa","bb","cc","dd",), typ=stringArgChecker(), settings=GlobalContextSettings(read_only = False, removable = False, transient = False, transient_index = False ))
    ...
    def test_globalSettings3(self):#test setTransientIndex in readonly mode
        c = ContextParameter( ("aa","bb","cc","dd",), typ=stringArgChecker(), settings=GlobalContextSettings(read_only=True ))
    ...
    def test_globalSettings6(self):#test getProperties not transient index
        c = ContextParameter( (0,1,2,3,) ,index=2, default_index=3, settings=GlobalContextSettings(transient_index = False))
    ...
    def test_globalSettings7(self):#test getProperties transient index
        c = ContextParameter( (0,1,2,3,) ,index=2, default_index=3, settings=GlobalContextSettings( transient_index=True))
    ...
    def test_contextConstructor10(self):#test transientIndex
        c = ContextParameter( (0,1,2,3,) ,index=2, settings=GlobalContextSettings(transient_index=False))
        self.assertFalse(c.settings.isTransientIndex())
        ...
        c = ContextParameter( (0,1,2,3,) ,index=2, settings=GlobalContextSettings(transient_index=True))
        self.assertTrue(c.settings.isTransientIndex())
    ...
    def test_context9(self):#removeValues, success remove with index computation
        c = ContextParameter( ("aa","bb","cc","dd",), typ=stringArgChecker(), default_index=2, index=3)
        self.assertEqual(c.getValue(), ["aa","bb","cc","dd"])
        self.assertEqual(c.settings.getDefaultIndex(), 2)
    ...
    def test_context14(self):
        c = ContextParameter( ("aa","bb","cc","dd",), settings=LocalContextSettings(read_only = True, removable = True), index=2, default_index=3)
        c.enableGlobal()
        self.assertIsInstance(c.settings, GlobalContextSettings)
        self.assertTrue(c.settings.isReadOnly())
        self.assertTrue(c.settings.isRemovable())
    ...
    def test_context15(self):
        c = ContextParameter( ("aa","bb","cc","dd",), settings=LocalContextSettings(read_only = False, removable = False), index=3, default_index=2)
        c.enableGlobal()
        self.assertIsInstance(c.settings, GlobalContextSettings)
        self.assertFalse(c.settings.isReadOnly())
        self.assertFalse(c.settings.isRemovable())
