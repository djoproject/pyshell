...
class splitAndMergeTest(unittest.TestCase):
    ...
    def test_skipOnCmd(self):
        ...
        self.assertTrue(self.e.cmd_list[1].isdisabledCmd(0))
        for i in range(1,6):
            self.assertFalse(self.e.cmd_list[1].isdisabledCmd(i))

        self.e._skipOnCmd(1,0,2)
        self.assertTrue(self.e.cmd_list[1].isdisabledCmd(0))
        self.assertTrue(self.e.cmd_list[1].isdisabledCmd(1))
        for i in range(2,6):
            self.assertFalse(self.e.cmd_list[1].isdisabledCmd(i))
        ...
        for i in range(2,4):
            self.assertFalse(self.e.cmd_list[1].isdisabledCmd(i))
        self.assertTrue(self.e.cmd_list[1].isdisabledCmd(4))
        self.assertFalse(self.e.cmd_list[1].isdisabledCmd(5))
        ...
        for i in range(2,4):
            self.assertFalse(self.e.cmd_list[1].isdisabledCmd(i))
        self.assertTrue(self.e.cmd_list[1].isdisabledCmd(4))
        self.assertTrue(self.e.cmd_list[1].isdisabledCmd(5))
        ...
        for i in range(2,4):
            if i == 3:
                self.assertFalse(self.e.cmd_list[1].isdisabledCmd(i))
                continue
            self.assertTrue(self.e.cmd_list[1].isdisabledCmd(i))
    ...
    def test_enableOnCmd(self):
        ...
        self.assertFalse(self.e.cmd_list[1].isdisabledCmd(0))
        for i in range(1,6):
            self.assertTrue(self.e.cmd_list[1].isdisabledCmd(i))

        self.e._enableOnCmd(1,0,2)
        self.assertFalse(self.e.cmd_list[1].isdisabledCmd(0))
        self.assertFalse(self.e.cmd_list[1].isdisabledCmd(1))
        for i in range(2,6):
            self.assertTrue(self.e.cmd_list[1].isdisabledCmd(i))
        ...
        for i in range(2,4):
            self.assertTrue(self.e.cmd_list[1].isdisabledCmd(i))
        self.assertFalse(self.e.cmd_list[1].isdisabledCmd(4))
        self.assertTrue(self.e.cmd_list[1].isdisabledCmd(5))
    ...
    def test_addSubCommand(self):
        ...
        self.assertEqual(len(self.e.cmd_list[1]), 2)
        ...
        self.assertEqual(len(self.e.cmd_list[0]), 1)
        self.assertEqual(len(self.e.cmd_list[1]), 3)
